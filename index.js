...
Do you follow it, or continue on your path?`)
    if (secondAnswer === 'follow it') {
        ...
        if(thirdAnswer === "ladder"){
            let thirdAnswer = window.alert("After ascending a few feet up the ladder, one of it's rungs snaps, and you comedically fall through each of the rungs below. Sheepish, you return home"
            );
        }
...
lead you away from the dragon altogether. Which path do you take?(Slay the Beast or tell the others)`
    );
    if (secondAnswer === "Past the dragon"){
        ...
        if (thirdAnswer === "Stay"){
            ...
            let thirdAnswer = window.alert("Quickly you run back to the cave's entrace. Sheepish, you return home.")
        }
    }
        ...
        if(thirdAnswer ==="Draw it"){
            let thirdAnswer = window.alert("You draw the flower, capturing only a fraction of it's beauty with your quill. You bring the drawing home, somewhat disappointed, but over time, discover joy in sharing it with your friends and family, recounting the story of your days as a sorcerer with the aid of the sketch")
        }
